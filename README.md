...
**[Hello-world-project]** is a project that involves creating and styling a hello world heading.
...
This project is usefull as it containes detailed commit messages and all the documents required in order to have a succesful git flow.
